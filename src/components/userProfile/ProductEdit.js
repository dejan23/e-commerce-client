...
class ProductEdit extends React.Component {
  ...
  submitForm = values => {
    ...
    this.props.startSetEditProduct(values)
      .then(() => {
       this.setState({
         isLoading: false
      })
          ...
          <form className="profile-addproduct-left" onSubmit={handleSubmit(this.submitForm.bind(this))}>
            ...
            <div className="profile-form-group">
              ...
              <div className="profile-options-content-product-image">
                <img src={this.props.initialValues.product_picture}></img>
              </div>

            </div>
            <div className="profile-addproduct-form-submit">
              <button className="button button--register" type="submit" disabled={this.state.isLoading || pristine}>Save</button>
            </div>
          </form>
